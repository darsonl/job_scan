...
4. **Cerrar el navegador**: Llamar `browser_close` al terminar de procesar todas las URLs. Libera la instancia del browser limpiamente y evita estado inválido en la siguiente sesión.
