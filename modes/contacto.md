...
2. **Classify contact type** -- ask candidate or infer from context:
   - **Recruiter** -- person whose role is talent acquisition, sourcing, or recruiting
   - **Hiring Manager** -- person who leads the hiring team
...
4. **Generate message** with 3-sentence framework adapted to contact type:
   ...
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement that demonstrates they've solved similar problems
